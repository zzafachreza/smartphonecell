...
class PosyanduBalita extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($data['memberadmin']['role_id'] == 1) {
            ...
            $this->load->view('page/posyandubalita/index', $data);
    ...
    public function add()
    {
        ...
        $this->load->view('templates/header', $data);
        // $this->load->view('topbar', $data);
        $this->load->view('page/posyandubalita/add', $data);
        $this->load->view('templates/footer');
    }

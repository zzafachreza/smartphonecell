...
<header>
    <nav>
        <a class="header-btn-back" href="<?= base_url('Misilevel/level') ?>">
            <img class="arrow-left" src="../assets/img/icon/left-arrow.png" alt="arrow-back">
        </a>
        <h3 class="header-title">Paket Bundling 1</h3>
...
<div class="container">
   ...
   <a href="<?= base_url('Misilevel/checkout'); ?>" class="btn-beli">
    <div class="btn-beli-container">
        <img class="icon-cart" src="../assets/img/icon/cart.png" alt="icon-cart" >
        <p class="title">Beli Sekarang</p>
    </div>
   </a>
</div>